...
# --------------------------
class AKIPredictor:
    def __init__(self, model_id="/home/work/llama2-7b/Llama-2-7b-hf"):
        try:
...
if __name__ == "__main__":
    try:
        ...
        # 1. 配置数据路径
        DATA_DIR = "/home/work/llama2-7b/data/csv"
        DATA_PATHS = {
        ...
        # model_save_path = "/home/work/llama2-7b/model/aki-classification-best-model_20260121_191125"
        # trained_model   = None
        #释放显存
        torch.cuda.empty_cache()
        ...
        if local_rank == 0:
            ...
            loaded_model = predictor.load_best_model("./aki-classification-best-model_20260122_200835")
